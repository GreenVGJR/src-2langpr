...
$if[$get[forcerefresh]==true;$setCache[authai_meta-yeszqvdv4sjhciobvr5cxq;]]
$jsonLoad[tsr;$default[$getCache[authai_meta-yeszqvdv4sjhciobvr5cxq];{}]]
...
require("undici").request("https://www.meta.ai", {
    method: "GET",
    headers: {
...
.then(a => {
    if(!ctx.hasKeyword("tempcookies")) { const r = typeof a.headers?.get==="function" ? a.headers.get("set-cookie") : a.headers?.\\["set-cookie"\\]\\; const f = Array.isArray(r) ? r\\[0\\] : r\\; if(f) ctx.setKeyword("cookies", f.split("\\;")\\[0\\])\\; }
    return a.body.text()
})
.catch()
]]
...
$setCache[authai_meta-yeszqvdv4sjhciobvr5cxq;$env[tsr]]
;
...
$if[$or[$env[tsr;docid;1]==;$env[tsr;asbd_id]==];
$let[m;true]
$let[k;true]
$let[docid_md;]
$let[asbd_id;]
...
$logger[Info;Looking ASBD ID & DocID]
$arrayForEach[a;aa;
$if[$or[$get[m];$get[k]];
$try[
...
$let[jyr_bd;$advancedTextSplit[$httpResult;ASBD_ID;0]]
$let[jyr_bd;$advancedTextSplit[$get[jyr_bd];function;$charCount[$get[jyr_bd];function]]]
$if[$advancedTextSplit[$get[jyr_bd];"use strict";1;a=";1;";0]!=;
$let[asbd_id;$advancedTextSplit[$get[jyr_bd];"use strict";1;a=";1;";0]]
$logger[Info;ASBD | $get[asbd_id]]
$let[k;false]
]
...
$try[
$httpSetBody[av=0&__user=0&__a=1&dpr=1&lsd=$get[lsd]&fb_api_caller_class=RelayModern&fb_api_req_friendly_name=useKadabraAcceptTOSForTempUserMutation&server_timestamps=true&doc_id=$get[docid_ls]&variables={"dob":"2000-01-01"}]
$httpSetContentType[Text]
$httpAddHeader[User-Agent;$get[agent]]
...
$httpAddHeader[x-asbd-id;$get[asbd_id]]
...
$!jsonSet[tsr;valid;true]
$!jsonSet[tsr;lsd;$get[lsd]]
$!jsonSet[tsr;asbd_id;$get[asbd_id]]
...
$httpAddHeader[Sec-Fetch-Mode;cors]
$httpAddHeader[Sec-Fetch-Site;same-site]
$httpAddHeader[User-Agent;$get[agent]]
$httpAddHeader[x-fb-friendly-name;useKadabraSendMessageMutation]
$!httpRequest[https://graph.meta.ai/graphql?locale=user;POST]
]]
$callLocalFunction[fetchmsg]
$if[$or[$httpResult[data;xfb_silverstone_send_message;bot_response_message]==null;$httpResult[data]==];
$callLocalFunction[fetchmetaweb]
$callLocalFunction[fetchmsg]
]
$arrayLoad[a;
...
$return[$default[$env[b;data;node;bot_response_message;snippet];$env[b;data;node;bot_response_message;content;agent_steps;0;composed_text;content;0;text]]]
    `
}
